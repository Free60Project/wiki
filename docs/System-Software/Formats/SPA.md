**SPA** files are contained inside [XEX](./XEX.md) files or within
Updates or DLC. They are just a [XDBF](./XDBF.md) file, they are
used by the dashboard for [GPD](./GPD.md) creation and Xbox LIVE information.
